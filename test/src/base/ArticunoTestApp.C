...
InputParameters
ArticunoTestApp::validParams()
{
  InputParameters params = ArticunoApp::validParams();
  params.set<bool>("use_legacy_material_output") = false;
  params.set<bool>("use_legacy_initial_residual_evaluation_behavior") = false;
  return params;
}

ArticunoTestApp::ArticunoTestApp(const InputParameters & parameters) : MooseApp(parameters)
{
